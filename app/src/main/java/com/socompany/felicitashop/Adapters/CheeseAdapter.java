...
public class CheeseAdapter extends FirebaseRecyclerAdapter<Products, ProductViewHolder> {

    private View.OnClickListener onItemClickListener;
    private int RecursionCounter;

    public CheeseAdapter(@NonNull FirebaseRecyclerOptions<Products> options) {
        super(options);
    }
