...
public class PastaAdapter extends FirebaseRecyclerAdapter<Products, ProductViewHolder> {
    private View.OnClickListener onItemClickListener;

    public PastaAdapter(@NonNull FirebaseRecyclerOptions<Products> options) {
        super(options);
    }
