...
public class CoffeeAdapter extends FirebaseRecyclerAdapter<Products, ProductViewHolder> {

    private View.OnClickListener onItemClickListener;
    private int RecursionCounter;

    public CoffeeAdapter(@NonNull FirebaseRecyclerOptions<Products> options) {
        super(options);
    }
