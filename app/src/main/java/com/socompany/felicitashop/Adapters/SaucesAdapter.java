...
public class SaucesAdapter extends FirebaseRecyclerAdapter<Products, ProductViewHolder> {
    private View.OnClickListener onItemClickListener;
    private int RecursionCounter;

    public SaucesAdapter(@NonNull FirebaseRecyclerOptions<Products> options) {
        super(options);
    }
